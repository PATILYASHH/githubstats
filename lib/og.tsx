...
// Renders the shared 1200x630 stats card for a GitHub handle. Used by both the
// home OG image (app/opengraph-image.tsx) and the per-user one
// (app/[username]/opengraph-image.tsx).
export async function renderStatsOgImage(handle: string): Promise<ImageResponse> {
  let stats = null;
  try {
